...
```{r}
set.seed(3003)
model_DNA = lm(formula = richness ~ 
                 poly(DPI, degree = 2) *Treatment * Added_Fc7,
               data = alpha_div_nj %>% dplyr::filter(Extraction == "DNA")) #model for DNA and RNA seperatly
...
saveRDS(object = alpha_with_estimate, file = paste0(filepath_results, "2023-02-03_16SrDNA_ASVrichness_emmip_estimates.RDS"))
```
